...
#define PAD6  DEVPIN(1, 5)  /* NOTE: PIN5@GPIO1 -> DEVPIN(1,5) = 0x00000025 = 0b0...00100101 */
#define   COL4 PAD6
...
#define NIMG 10 // NOTE: 10 porque lo que contiene una imagen son 5 parejas de 2 elementos cada una, que son, respectivamente, los conjuntos de señales del GPIO0 y el GPIO1

typedef unsigned image[NIMG];

#define LED_MASK0 0xd1688800 /* 1101 0001 0110 1000 1000 1000 0000 0000 -> NOTE: la escritura de un 1 indica que pin estará LOW, y un 0 lo deja como estaba. Si tan solo leyeras el registro, un 1 indicaría que ese pin tiene un valor de voltaje alto y, un 0, voltaje bajo (0V supongo). Aquí está poniendo a LOW todos los pines de las filas (ROWx -> "hardware.txt") y las columnas (COLx) 1,2, 3 y 5*/
#define LED_MASK1 0x00000020 /* 0000 0000 0000 0000 0000 0000 0001 0000 -> NOTE: aquí pone a LOW la columna (COLx) 4*/
#define LED_DOT0  0x50008800 /* 0101 0000 0000 0000 1000 1000 0000 0000 */
#define LED_DOT1  0x00000020

/* NOTE: la macro "ROW" lo que hace es generar parejas de valores donde el
 * primero constituye el conjunto de señales de control del GPIO0 y, el segundo,
 * las del GPIO1 y, como en este último tan solo se encuentra el pin de la
 * columna 4 (COL4), no es necesario combinarlo con otras señales de control.
 * El valor del GPIO0 debe contener los valores de los pines de filas (ROWx) y
 * columnas (COLx), por lo que se hace la composición de esas señales con un OR
 * lógico bit a bit */
